...
const generateRoomId = () => {
    // Generate a random 9-character string structured like 'abc-def-ghi' for readability
                ...
                <div className="w-full">
                    <header className="mb-10 text-center">
                        ...
                        <p className="text-on-surface-variant text-lg">
                            Create a collaborative environment for your team.
                        </p>
                    </header>
                        ...
                        <form className="space-y-8" onSubmit={handleCreateRoom}>
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <p className="font-medium text-on-surface">
                                                Auto-Generated Secure Room ID
                                            </p>
                                            <p className="text-xs text-on-surface-variant">
                                                Your room code will be instantly generated
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="pt-2 flex flex-col gap-4">
                                ...
                                <button
                                    ...
                                    className="text-on-surface-variant hover:text-primary text-sm font-medium transition-colors flex items-center gap-1 justify-center mt-2 group"
                                >
