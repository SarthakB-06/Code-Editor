        ...
        <div className="bg-background text-on-surface font-body selection:bg-primary/30 min-h-screen flex flex-col relative overflow-hidden">
            ...
            <nav className="bg-surface-container font-['Inter'] tracking-tight flex justify-between items-center w-full px-6 py-4 fixed top-0 z-50 border-b border-outline-variant/20">
                ...
                <div className="flex items-center gap-4">
                    <button onClick={() => navigate('/auth')} className="px-4 py-2 text-primary font-semibold hover:text-primary-fixed transition-colors duration-200">
                        Authentication
                    </button>
                </div>
            </nav>
            ...
            <main className="flex-grow flex items-center justify-center pt-24 pb-12 px-6 relative z-10 w-full max-w-[520px] mx-auto">
                <div className="w-full glass-effect rounded-xl p-10 border border-outline-variant/15 flex flex-col justify-center shadow-[0_12px_32px_rgba(0,0,0,0.4)]">
                    <div className="mb-10 text-center">
                        <h1 className="text-4xl md:text-5xl font-black tracking-tighter text-on-surface mb-3 leading-tight">Enter Workspace</h1>
                    ...
                    <div className="space-y-8">
                        <div className="space-y-2">
                            <label className="text-[10px] uppercase tracking-[0.2em] font-bold text-on-surface-variant/70 pl-1">Room Identifier</label>
                        ...
                        <div className="flex flex-col gap-4 mt-2">
                            <button 
                                ...
                                <span>Join Room</span>
                                <span className="material-symbols-outlined text-xl group-hover:translate-x-1 transition-transform" style={{ fontVariationSettings: "'FILL' 0, 'wght' 400, 'GRAD' 0, 'opsz' 24" }}>arrow_forward</span>
                            </button>
                            
                            <div className="text-center mt-2">
                                <button onClick={handleCreateNew} className="text-primary hover:text-primary-fixed text-sm font-semibold transition-colors duration-200">
